...
* DKIM - so i'm not a spammer
    ...
    sudo perl -pi -e 's/#DAEMON_OPTS="\$DAEMON_OPTS -d example.com -s \/etc\/mail\/domainkey.key -S 2007"/DAEMON_OPTS="\$DAEMON_OPTS -d tigris.id.au -s \/etc\/mail\/dkim.key -S mail"/' /etc/default/dk-filter
